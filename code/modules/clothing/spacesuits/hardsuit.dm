...
/obj/item/clothing/head/helmet/space/hardsuit
	...
	item_state = "eng_helm"
	max_integrity = 300
	armor = list("melee" = 25, "bullet" = 15, "laser" = 15, "energy" = 20, "bomb" = 10, "bio" = 100, "rad" = 75, "fire" = 50, "acid" = 75)
...
/obj/item/clothing/head/helmet/space/hardsuit/engine
	...
	icon_state = "hardsuit0-engineering"
	item_state = "eng_helm"
	armor = list("melee" = 40, "bullet" = 35, "laser" = 30, "energy" = 25, "bomb" = 60, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 75)
...
/obj/item/clothing/suit/space/hardsuit/engine/atmos
	...
	armor = list("melee" = 40, "bullet" = 35, "laser" = 30, "energy" = 25, "bomb" = 60, "bio" = 100, "rad" = 25, "fire" = 100, "acid" = 75)
...
/obj/item/clothing/head/helmet/space/hardsuit/engine/elite
	...
	item_state = "ce_helm"
	hardsuit_type = "white"
	armor = list("melee" = 50, "bullet" = 40, "laser" = 35, "energy" = 30, "bomb" = 80, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 90)
...
/obj/item/clothing/head/helmet/space/hardsuit/mining
	...
	resistance_flags = FIRE_PROOF
	heat_protection = HEAD
	armor = list("melee" = 45, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 50, "bio" = 100, "rad" = 50, "fire" = 50, "acid" = 75)
	light_range = 7
...
/obj/item/clothing/suit/space/hardsuit/mining/heavy
	...
	armor = list("melee" = 60, "bullet" = 40, "laser" = 40, "energy" = 45, "bomb" = 75, "bio" = 100, "rad" = 100, "fire" = 75, "acid" = 100)
	allowed = list(/obj/item/flashlight, /obj/item/tank/internals, /obj/item/storage/bag/ore, /obj/item/pickaxe)
...
/obj/item/clothing/head/helmet/space/hardsuit/syndi
	...
	hardsuit_type = "syndi"
	armor = list("melee" = 50, "bullet" = 60, "laser" = 40, "energy" = 50, "bomb" = 65, "bio" = 100, "rad" = 75, "fire" = 50, "acid" = 90)
	on = TRUE
...
/obj/item/clothing/head/helmet/space/hardsuit/syndi/elite
	...
	armor = list("melee" = 70, "bullet" = 70, "laser" = 60, "energy" = 70, "bomb" = 75, "bio" = 100, "rad" = 90, "fire" = 100, "acid" = 100)
	heat_protection = HEAD
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
	resistance_flags = FIRE_PROOF | ACID_PROOF
...
/obj/item/clothing/head/helmet/space/hardsuit/security
	...
	item_state = "sec_helm"
	hardsuit_type = "sec"
	armor = list("melee" = 50, "bullet" = 30, "laser" = 30, "energy" = 40, "bomb" = 25, "bio" = 100, "rad" = 50, "fire" = 75, "acid" = 75)
...
/obj/item/clothing/head/helmet/space/hardsuit/swat
	...
	armor = list("melee" = 60, "bullet" = 60, "laser" = 60, "energy" = 60, "bomb" = 50, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100)
	resistance_flags = FIRE_PROOF | ACID_PROOF
